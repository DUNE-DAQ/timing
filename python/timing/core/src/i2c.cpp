...
register_i2c(py::module& m) {
  ...
  py::class_<timing::I2CMasterNode, uhal::Node> (m, "I2CMasterNode")
    ...
    .def("write_i2c", &timing::I2CMasterNode::write_i2c, py::arg("i2c_device_address"), py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
    .def("read_i2cArray", &timing::I2CMasterNode::read_i2cArray)
    .def("write_i2cArray", &timing::I2CMasterNode::write_i2cArray, py::arg("i2c_device_address"), py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
    .def("read_i2cPrimitive", &timing::I2CMasterNode::read_i2cPrimitive)
    .def("write_i2cPrimitive", &timing::I2CMasterNode::write_i2cPrimitive, py::arg("i2c_device_address"), py::arg("data"), py::arg("send_stop") = true)
  ...
  py::class_<timing::I2CSlave>(m, "I2CSlave")
    ...
    .def<uint8_t (timing::I2CSlave::*)(uint32_t) const>("read_i2c", &timing::I2CSlave::read_i2c)
    .def<uint8_t (timing::I2CSlave::*)(uint32_t,uint32_t) const>("read_i2c", &timing::I2CSlave::read_i2c)
    .def<void (timing::I2CSlave::*)(uint32_t,uint8_t,bool) const>("write_i2c", &timing::I2CSlave::write_i2c, py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
    .def<void (timing::I2CSlave::*)(uint32_t,uint32_t,uint8_t,bool) const>("write_i2c", &timing::I2CSlave::write_i2c, py::arg("i2c_device_address"), py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
    .def<std::vector<uint8_t> (timing::I2CSlave::*)(uint32_t,uint32_t) const>("read_i2cArray", &timing::I2CSlave::read_i2cArray)
    .def<std::vector<uint8_t> (timing::I2CSlave::*)(uint32_t,uint32_t,uint32_t) const>("read_i2cArray", &timing::I2CSlave::read_i2cArray)
    .def<void (timing::I2CSlave::*)(uint32_t, std::vector<uint8_t>,bool) const>("write_i2cArray", &timing::I2CSlave::write_i2cArray, py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
    .def<void (timing::I2CSlave::*)(uint32_t,uint32_t, std::vector<uint8_t>,bool) const>("write_i2cArray", &timing::I2CSlave::write_i2cArray, py::arg("i2c_device_address"), py::arg("i2c_reg_address"), py::arg("data"), py::arg("send_stop") = true)
  ...
  py::class_<timing::SIChipSlave, timing::I2CSlave> (m, "SIChipSlave")
    .def(py::init<const timing::I2CMasterNode*, uint8_t>())
  ...
  // Wrap DACNode
  py::class_<timing::DACNode, timing::DACSlave, timing::I2CMasterNode> (m, "DACNode")
    .def(py::init<const uhal::Node&>())
    ;
