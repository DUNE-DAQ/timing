...
package ipbus_decode_pdts_fib_v2_io is

  constant IPBUS_SEL_WIDTH: positive := 4;
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_pdts_fib_v2_io(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;

-- START automatically generated VHDL (Thu Oct 17 11:01:01 2024)
...
end ipbus_decode_pdts_fib_v2_io;

package body ipbus_decode_pdts_fib_v2_io is

  function ipbus_sel_pdts_fib_v2_io(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
...
-- START automatically generated VHDL (Thu Oct 17 11:01:01 2024)
    if    std_match(addr, "-------------------------0000-0-") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_I2C, IPBUS_SEL_WIDTH)); -- i2c / base 0x00000008 / mask 0x00000078
...
-- END automatically generated VHDL
  ...
  end function ipbus_sel_pdts_fib_v2_io;
