...
#ifndef TIMING_TEST_SRC_TIMINGSYSTEMMANAGERBASE_HPP_
#define TIMING_TEST_SRC_TIMINGSYSTEMMANAGERBASE_HPP_
...
#endif // TIMING_TEST_SRC_TIMINGSYSTEMMANAGERBASE_HPP_
