...
local tei = import "pdt-timingendpointinfo.jsonnet";
local thi = import "pdt-timinghardwareinfo.jsonnet";

// A schema builder in the given path (namespace)
local ns = "dunedaq.pdt.timingfirmwareinfo";
...
local timingfirmwareinfo = {
    ...
    [
        s.field("class_name", self.text_data, "TimingPDIMasterTLUMonitorData",
                doc="Info class name"),
        s.field("hardware_data", thih.dunedaq.pdt.timinghardwareinfo.TimingTLUMonitorData,
    ...
    [
        s.field("class_name", self.text_data, "TimingPDIMasterTLUMonitorDataDebug",
                doc="Info class name"),
        s.field("hardware_data", thih.dunedaq.pdt.timinghardwareinfo.TimingTLUMonitorDataDebug,
                doc="TLU hardware monitor data"),
        s.field("time_gathered", self.l_int, 0,
                doc="When was the data actually gathered"),
    ], 
    ...
    [
        s.field("class_name", self.text_data, "TimingPDIMasterFMCMonitorData",
                doc="Info class name"),
        s.field("hardware_data", thih.dunedaq.pdt.timinghardwareinfo.TimingFMCMonitorData,
    ...
    [
        s.field("class_name", self.text_data, "TimingPDIMasterFMCMonitorDataDebug",
                doc="Info class name"),
        s.field("hardware_data", thih.dunedaq.pdt.timinghardwareinfo.TimingFMCMonitorDataDebug,
                doc="FMC hardware monitor data"),
        s.field("time_gathered", self.l_int, 0,
                doc="When was the data actually gathered"),
    ], 
    ...
    [
        ...
        s.field("hardware_data", thih.dunedaq.pdt.timinghardwareinfo.TimingFMCMonitorData,
                doc="FMC hardware monitor data"),
        s.field("firmware_data", teih.dunedaq.pdt.timingendpointinfo.TimingEndpointInfo,
