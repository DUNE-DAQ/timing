...
register_endpoint(py::module& m) {
  ...
  py::class_<timing::HSINode, uhal::Node> (m, "HSINode")
      ...
      .def("configure_hsi", &timing::HSINode::configure_hsi, py::arg("src"), py::arg("re_mask"), py::arg("fe_mask"), py::arg("inv_mask"), py::arg("dispatch") = true)
      ...
      .def("get_data_buffer_table", &timing::HSINode::get_data_buffer_table, py::arg("read_all") = false, py::arg("print_out") = false)
