...
//
    ...
    [
        s.field("state", self.reg_val,
                doc="Endpoint state"),
        s.field("ready", self.bool_data, 0,
                doc="Endpoint ready flag"),
        s.field("partition", self.reg_val, 0,
                doc="Endpoint partition"),
        s.field("address", self.reg_val, 0,
        ...
        s.field("buffer_occupancy", self.reg_val,
                doc="Buffer occupancy"),
        s.field("event_counter", self.reg_val,
                doc="Event counter"),
        ...
        s.field("coarse_delay", self.reg_val,
                doc="Configured coarse delay"),
        s.field("fine_delay", self.reg_val,
