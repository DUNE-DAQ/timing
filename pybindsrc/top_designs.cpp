...
register_top_designs(py::module& m)
{
  ...
  py::class_<timing::OverlordDesign<TLUIONode>, uhal::Node>(m, "OverlordDesign<TLUIONode>")
    ...
    .def("apply_endpoint_delay", 
          &timing::OverlordDesign<TLUIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
    ...
    .def("measure_endpoint_rtt", 
          &timing::OverlordDesign<TLUIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::OverlordDesign<FMCIONode>, uhal::Node>(m, "OverlordDesign<FMCIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::OverlordDesign<FMCIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::OverlordDesign<FMCIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
    .def("get_external_triggers_endpoint_node",
  ...
  py::class_<timing::BoreasDesign<FMCIONode>, uhal::Node>(m, "BoreasDesign<FMCIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::BoreasDesign<FMCIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::BoreasDesign<FMCIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::BoreasDesign<TLUIONode>, uhal::Node>(m, "BoreasDesign<TLUIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::BoreasDesign<TLUIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::BoreasDesign<TLUIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::BoreasDesign<SIMIONode>, uhal::Node>(m, "BoreasDesign<SIMIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::BoreasDesign<SIMIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::BoreasDesign<SIMIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::FanoutDesign<PC059IONode, PDIMasterNode>, uhal::Node>(m, "FanoutDesign<PC059IONode,PDIMasterNode>")
    ...
    .def("apply_endpoint_delay", 
          &timing::FanoutDesign<PC059IONode, PDIMasterNode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::FanoutDesign<PC059IONode, PDIMasterNode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::FanoutDesign<FIBIONode, PDIMasterNode>, uhal::Node>(m, "FanoutDesign<FIBIONode,PDIMasterNode>")
    ...
    .def("apply_endpoint_delay", 
          &timing::FanoutDesign<FIBIONode, PDIMasterNode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::FanoutDesign<FIBIONode, PDIMasterNode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::OuroborosMuxDesign<PC059IONode>, uhal::Node>(
    ...
    .def("apply_endpoint_delay", 
          &timing::OuroborosMuxDesign<PC059IONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::OuroborosMuxDesign<PC059IONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::OuroborosMuxDesign<FIBIONode>, uhal::Node>(
    ...
    .def("apply_endpoint_delay", 
          &timing::OuroborosMuxDesign<FIBIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::OuroborosMuxDesign<FIBIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1)
  ...
  py::class_<timing::OuroborosDesign<FMCIONode>, uhal::Node>(m, "OuroborosDesign<FMCIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::OuroborosDesign<FMCIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::OuroborosDesign<FMCIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1);
  ...
  py::class_<timing::OuroborosDesign<SIMIONode>, uhal::Node>(m, "OuroborosDesign<SIMIONode>")
    ...
    .def("enable_fake_trigger",
         ...
         py::arg("poisson"))
    .def("apply_endpoint_delay", 
          &timing::OuroborosDesign<SIMIONode>::apply_endpoint_delay,
          py::arg("address"),
          py::arg("coarse_delay"),
          py::arg("fine_delay"),
          py::arg("phase_delay"),
          ...
          py::arg("sfp_mux") = -1)
    .def("measure_endpoint_rtt", 
          &timing::OuroborosDesign<SIMIONode>::measure_endpoint_rtt,
          py::arg("address"),
          py::arg("control_sfp") = true,
          py::arg("sfp_mux") = -1);
